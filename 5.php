...
$db = new mysqli('localhost', 'root', '', 'amasty');

$balances_query = 'SELECT (100 -
...
$res = $db->query($cities_query);

while($city = $res->fetch_row())
    echo $city[0] . '<br>';

$same_cities_query = 'SELECT t.transaction_id, t.from_person_id, t.to_person_id, t.amount FROM transactions as t
...
$res = $db->query($same_cities_query);
